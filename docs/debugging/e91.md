...
2. **Report the crash** — If E91 is accompanied by a previous panic (look for a `Panic` entry in the error log), open an issue on [GitHub](https://github.com/FKMTime/firmware) with your firmware version and a description of what happened before the crash.
