...
3. **Contact support** — If this error appears consistently with the battery properly connected, the fuel gauge IC may be faulty. Open an issue on [GitHub](https://github.com/FKMTime/FKMTime).
