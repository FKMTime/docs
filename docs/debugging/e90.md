...
3. **Report the issue** — E90 always indicates a crash loop that needs investigation. Open an issue on [GitHub](https://github.com/FKMTime/firmware) with the firmware version and as much context as possible about what the device was doing before it started crashing.
