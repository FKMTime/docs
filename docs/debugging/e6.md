...
3. **Contact support** — If this error appears during normal competition operation, open an issue on [GitHub](https://github.com/FKMTime/firmware) and attach the micro-connector logs.
