...
2. **Contact support** — Open an issue on [GitHub](https://github.com/FKMTime/firmware) with the FKMTime Display firmware version. Include whether [E58](e58) also appears.
