...
3. **Contact support** — Open an issue on [GitHub](https://github.com/FKMTime/FKMTime) if this appears consistently, especially if it coincides with missing solve submissions.
