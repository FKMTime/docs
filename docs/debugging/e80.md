...
3. **Contact support** — Open an issue on [GitHub](https://github.com/FKMTime/FKMTime) and note which functionality is missing (which subsystem is not working), as that will identify which task failed.
